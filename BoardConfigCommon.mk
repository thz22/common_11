...
TARGET_PREBUILT_DTB := $(VENDOR_PATH)/prebuilt/dtb.img
TARGET_PREBUILT_KERNEL := $(VENDOR_PATH)/prebuilt/$(BOARD_KERNEL_IMAGE_NAME)
BOARD_PREBUILT_DTBOIMAGE := $(VENDOR_PATH)/prebuilt/dtbo.img
TARGET_FORCE_PREBUILT_KERNEL := true

LOCAL_KERNEL := $(VENDOR_PATH)/prebuilt/Image.gz
PRODUCT_COPY_FILES += \
    $(LOCAL_KERNEL):kernel

BOARD_PREBUILT_DTBIMAGE_DIR := $(VENDOR_PATH)/prebuilt
